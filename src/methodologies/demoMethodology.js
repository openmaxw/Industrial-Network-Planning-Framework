  ...
  cases: [
    {
      ...
      recordCollections: {
        'business-description': [
          { 'business.name': '焊装产线', 'business.zone': '区域1' },
          { 'business.name': '总装产线', 'business.zone': '区域2' },
        ],
      },
    },
    {
      ...
      recordCollections: {
        'business-description': [
          { 'business.name': '原料处理', 'business.zone': '工艺区' },
          { 'business.name': '灌装包装', 'business.zone': '包装区' },
        ],
      },
    },
    {
      ...
      recordCollections: {
        'business-description': [
          { 'business.name': '主站监控', 'business.zone': '监控区' },
          { 'business.name': '现场采集', 'business.zone': '现场区' },
        ],
      },
    },
  ],
