...
export const methodologyCatalog = [
  ...
  {
    key: 'scenario-semiconductor-fab',
    title: '半导体工厂',
    description: '聚焦晶圆厂多公辅系统、厂务监控与连续性规划经验。',
    tags: ['应用场景角度', '半导体', '厂务系统'],
    audience: ['FAE', '方案工程师'],
    status: '待建设',
    available: false,
  },
  {
    key: 'scenario-rail-transit',
    title: '轨道交通行业',
    description: '聚焦车站、线路、控制中心之间的工业网络规划经验。',
    tags: ['应用场景角度', '轨道交通', '站线协同'],
    audience: ['FAE', '方案工程师'],
    status: '待建设',
    available: false,
  },
